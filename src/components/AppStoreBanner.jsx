...
const AppStoreBanner = () => {
  return (
  <div className="bg-gray-100 dark:bg-gray-800 text-white p-10 " style={bannerImg}>
        <div className="container">
            <div className='space-y-6 max-w-xl mx-auto'>
                <h1 className='text-2xl text-centersm:text-4xl font-semibold'>Read Books at your fingertips</h1>
